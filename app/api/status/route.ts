    ...
    return Response.json(
      {
        ...
        strategy: {
          ...
          holdDuringDraftRound: config.holdDuringDraftRound,
          ...
          volumeMaxMode: config.volumeMaxMode,
          volumeMaxRoundNumber: config.volumeMaxRoundNumber,
          volumeMaxTargetVolume: config.volumeMaxTargetVolume,
          volumeRankChasingEnabled: config.volumeRankChasingEnabled,
          volumeRankChasingMarginPct: config.volumeRankChasingMarginPct,
          volumeRankChasingMinElapsedPct: config.volumeRankChasingMinElapsedPct,
          volumeRankChasingMaxTargetVolume: config.volumeRankChasingMaxTargetVolume,
          volumeMaxCatchupScale: config.volumeMaxCatchupScale,
          volumeMaxMarketsPerTick: config.volumeMaxMarketsPerTick,
          volumeMaxOrdersPerTick: config.volumeMaxOrdersPerTick,
          volumeMaxPointsOrderNotionalPct: config.volumeMaxPointsOrderNotionalPct,
          volumeMaxPointsMaxMarketExposurePct: config.volumeMaxPointsMaxMarketExposurePct,
          volumeMaxBookParticipationPct: config.volumeMaxBookParticipationPct,
          volumeMaxQuoteTtlSeconds: config.volumeMaxQuoteTtlSeconds,
